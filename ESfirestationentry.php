...
<center>
<form method="post" action="ESfirestationphp.php">
<div id="maindiv">
<div id="headerdiv">
<label style="position:relative; font-size:26px; top:8px; color:#FFFFFF"><b>FIRE STATION INFORMATION</b></label>
</div>
<div id="bodydiv2">
...
<tr><td width="210"></td><td><b>Emergency ID</b></td><td><font color="#999999"><?php echo $row['EmergId']; ?></font></td><td></td></tr>
<tr><td></td><td><b>Location of Fire Station</b></td><td><input type="text" value="<?php echo $row['FSLoc']; ?>" name="f2"></td><td></td></tr>
<tr><td></td><td><b>Phone No. of Fire Station</b></td><td><input type="number" value="<?php echo $row['FSPhnNo']; ?>" name="f3"></td><td></td></tr>
<tr><td></td><td><b>Distance of Fire station</b></td><td><input type="text" value="<?php echo $row['FSDistance']; ?>" name="f4"></td><td></td></tr>
<tr><td></td><td><b>Other No. of Fire Station</b></td><td><input type="number" value="<?php echo $row['otherFSNo']; ?>" name="f5"></td><td></td></tr>
<tr><td></td><td></td><td><input type="submit" value="update" name="f6"/></td><td></td></tr>
</table>
</div>
<?php
}
