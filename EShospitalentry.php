...
<center>
<form method="post" action="EShospitalphp.php">
<div id="maindiv">
<div id="headerdiv">
<label style="position:relative; font-size:26px; top:8px; color:#FFFFFF"><b>CALLER HOSPITAL INFORMATION AND PHONE NUMBER</b></label>
</div>
<div id="bodydiv2">
...
<tr><td width="210"></td><td><b>Hospital Code</b></td><td><input type="number" name="h1"></td><td></td></tr>
<tr><td></td><td><b>Emergency Number</b></td><td><font color="#999999"><?php echo $row['EmergId']; ?></font></td><td></td></tr>
<tr><td></td><td><b>Name of Hospital</b></td><td><input type="text" value="<?php echo $row['HName']; ?>" name="h3"></td><td></td></tr>
<tr><td></td><td><b>Name of 2nd Hospital</b></td><td><input type="text" value="<?php echo $row['H2Name']; ?>" name="h4"></td><td></td></tr>
<tr><td></td><td><b>Ambulance Phone No.</b></td><td><input type="number" value="<?php echo $row['AmbNo']; ?>" name="h5"></td><td></td></tr>
<tr><td></td><td><b>Distance 1</b></td><td><input type="number" value="<?php echo $row['Distance1']; ?>" name="h6"></td><td></td></tr>
<tr><td></td><td><b>Distance 2</b></td><td><input type="number"  value="<?php echo $row['Distance2']; ?>" name="h7"></td><td></td></tr>
<tr><td></td><td><b>Hospital Phone No.</b></td><td><input type="number"  value="<?php echo $row['H1PhnNo']; ?>" name="h8"></td><td></td></tr>
<tr><td></td><td><b>Hospital Phone No.</b></td><td><input type="number" value="<?php echo $row['H2PhnNo']; ?>" name="h9"></td><td></td></tr>
<tr><td></td><td></td><td><input type="submit" value="update" name="h10" /></td><td></td></tr>
</table>
</div>
<?php
}
