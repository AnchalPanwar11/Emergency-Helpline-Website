...
<center>
<form method="post" action="ESchildinfophp.php">
<div id="maindiv">
<div id="headerdiv">
<label style="position:relative; font-size:26px; top:8px; color:#FFFFFF"><b>CHILD INFORMATION</b></label>
</div>
<div id="bodydiv2">
...
<tr><td width="20"></td><td><b>Children Information of Caller</b></td><td><input type="text" value="<?php echo $row['CIcaller']; ?>" name="c1"></td><td width="10"></td><td><b>Emergency ID</b></td><td><font color="#999999"><?php echo $row['EmergId']; ?></font></td><td></td>
</tr><tr><td></td></tr>
<tr><td></td><td><b>Name</b></td><td><input type="text" value="<?php echo $row['CName1']; ?>" name="c3"></td><td width="10"></td><td><b>Age</b></td><td><input type="number" value="<?php echo $row['CAge1']; ?>" name="c4"></td><td width="10"></td><td><b>Blood Group</b></td><td><select name="c5">
...
</select></td><td width="180">
</td></tr>
<tr><td></td><td><b>Name</b></td><td><input type="text" value="<?php echo $row['CName2']; ?>" name="c6"></td><td width="10"></td><td><b>Age</b></td><td><input type="number" value="<?php echo $row['CAge2']; ?>" name="c7"></td><td width="10"></td><td><b>Blood Group</b></td><td><select name="c8" >
...
<tr><td></td><td><b>Name</b></td><td><input type="text" value="<?php echo $row['CName3']; ?>" name="c9"></td><td width="10"></td><td><b>Age</b></td><td><input type="number" value="<?php echo $row['CAge3']; ?>" name="c10"></td><td width="10"></td><td><b>Blood Group</b></td><td><select name="c11" >
...
<tr><td></td><td></td><td></td><td><input type="submit" value="update" name="c12"/></td><td></td><td></td></tr>
</table>
</div>
<?php
}
