...
<center>
<form method="post" action="ESpolicstationphp.php">
<div id="maindiv">
<div id="headerdiv">
<label style="position:relative; font-size:26px; top:8px; color:#FFFFFF"><b>POLICE STATION INFORMATION</b></label>
</div>
<div id="bodydiv2">
...
<tr><td></td><td><b>Emergency No.</b></td><td><font color="#999999"><?php echo $row['EmergId']; ?></font></td><td></td></tr>
<tr><td width="210"></td><td><b>Police Station Details</b></td><td><input type="text" value="<?php echo $row['PSdet']; ?>" name="p1"></td><td></td></tr>
<tr><td></td><td><b>Name of Police Station</b></td><td><input type="text" value="<?php echo $row['PSName']; ?>" name="p2"></td><td></td></tr>
<tr><td></td><td><b>Control Room No.</b></td><td><input type="text" value="<?php echo $row['ControlRoomNo']; ?>" name="p3"></td><td></td></tr>
<tr><td></td><td><b>Emergency No.</b></td><td><input type="number" value="<?php echo $row['EmergId']; ?>" name="p4"></td><td></td></tr>
<tr><td></td><td><b>Distance</b></td><td><input type="number" value="<?php echo $row['Distance']; ?>" name="p5"></td><td></td></tr>
<tr><td></td><td><b>CO City Phone No.</b></td><td><input type="number" value="<?php echo $row['COPhnNo']; ?>" name="p6"></td><td></td></tr>
<tr><td></td><td><b>Caller ID</b></td><td><input type="text" value="<?php echo $row['CallerID']; ?>" name="p7"></td><td></td></tr>
<tr><td></td><td></td><td><input type="submit" value="update" name="p8"/></td><td></td></tr>
</table>
</div>
<?php
}
